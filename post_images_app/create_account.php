...
<head>
    <meta charset="UTF-8">
    <title>Truth Rose | Create Account </title>
...
<body>
    <form method="post">
        ...
        <p><input type="password" id="retyped_password" name="retyped_password" placeholder="Retype password"></p>
        <p><input type="submit" id="account" name="account" value="Create account"></p>
    </form>
